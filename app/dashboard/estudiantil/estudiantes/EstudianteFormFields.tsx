  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
      <label className="flex flex-col gap-1.5 text-sm font-semibold text-gray-700">
        ...
        <input
          name="nroCedula"
          defaultValue={estudiante?.nroCedula ?? ""}
          inputMode="numeric"
          pattern="[0-9]{7,10}"
          minLength={7}
          maxLength={10}
      ...
      <label className="flex flex-col gap-1.5 text-sm font-semibold text-gray-700">
        ...
        <input
          name="primerNombre"
          defaultValue={estudiante?.primerNombre ?? ""}
          minLength={2}
          maxLength={50}
          required
          className={inputClass}
      ...
      <label className="flex flex-col gap-1.5 text-sm font-semibold text-gray-700">
        ...
        <input
          name="segundoNombre"
          defaultValue={estudiante?.segundoNombre ?? ""}
          minLength={2}
          maxLength={50}
          required
          className={inputClass}
      ...
      <label className="flex flex-col gap-1.5 text-sm font-semibold text-gray-700">
        ...
        <input
          type="number"
          name="anioMatricula"
          defaultValue={estudiante?.anioMatricula ?? new Date().getFullYear()}
          min={1900}
          required
          className={inputClass}
        />
      ...
      <label className="flex flex-col gap-1.5 text-sm font-semibold text-gray-700">
        ...
        <select
          name="jornada"
          defaultValue={estudiante?.jornada ?? ""}
          required
          className={inputClass}
        >
          <option value="" disabled>
      ...
      <label className="flex flex-col gap-1.5 text-sm font-semibold text-gray-700">
        ...
        <input
          ...
          defaultValue={estudiante?.fechaNacimiento?.slice(0, 10) ?? ""}
          required
          className={inputClass}
        />
      </label>
      <label className="flex flex-col gap-1.5 text-sm font-semibold text-gray-700">
        ...
        <select
          name="grupoEtnico"
          defaultValue={estudiante?.grupoEtnico ?? ""}
          required
          className={inputClass}
        >
          <option value="" disabled>
          ...
          {GRUPOS_ETNICOS_ESTUDIANTE.map((value) => (
            <option key={value}>{value}</option>
          ))}
        </select>
      </label>
      ...
      <label className="flex flex-col gap-1.5 text-sm font-semibold text-gray-700">
        ...
        <input
          type="number"
          name="nroMatricula"
          defaultValue={estudiante?.nroMatricula ?? 1}
          min={1}
          required
          className={inputClass}
        />
      ...
      <label className="flex flex-col gap-1.5 text-sm font-semibold text-gray-700 sm:col-span-2">
        ...
        <select
          ...
          defaultValue={estudiante?.representanteId ?? ""}
          required
          className={inputClass}
        >
          <option value="" disabled>
